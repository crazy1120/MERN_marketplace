  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <Typography
        variant="h1"
        color="black"
        className="mx-auto my-6 w-full max-w-[550px] text-center font-heading text-[2.75rem] font-black leading-none md:max-w-[780px] md:text-7xl xl:text-[5.5rem]"
      >
