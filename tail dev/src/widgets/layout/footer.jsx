...
export const Footer = ({ title, description, socials, menus, copyright }) => {
  return (
    <footer className="relative bg-black px-4 pb-6 pt-8 text-white">
...
Footer.defaultProps = {
  ...
  copyright: (
    <>
      Copyright © {year} MarketPlace by{" "}
      <a href="https://www.creative-tim.com?ref=mtk" target="_blank">
        Libright
      </a>
      .
    </>
